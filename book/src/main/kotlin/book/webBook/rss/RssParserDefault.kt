...
object RssParserDefault {
    ...
    fun parseXML(
        ...
        var currentArticle = RssArticle(userid=userid)
        ...
        articleList.firstOrNull()?.let {
            debugLogger?.log(sourceUrl, "┌获取标题")
            debugLogger?.log(sourceUrl, "└${it.title}")
            debugLogger?.log(sourceUrl, "┌获取时间")
            debugLogger?.log(sourceUrl, "└${it.pubDate}")
            debugLogger?.log(sourceUrl, "┌获取描述")
            debugLogger?.log(sourceUrl, "└${it.description}")
            debugLogger?.log(sourceUrl, "┌获取图片url")
            debugLogger?.log(sourceUrl, "└${it.image}")
            debugLogger?.log(sourceUrl, "┌获取文章链接")
            debugLogger?.log(sourceUrl, "└${it.link}")
        }
